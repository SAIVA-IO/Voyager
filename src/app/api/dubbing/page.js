...
import { ArrowRight, ArrowLeft, Check, Video } from "lucide-react";

const endpoints = [
  { method: "POST", path: "/v1/dubbing", desc: "Start dubbing a video" },
  { method: "GET", path: "/v1/dubbing/:id", desc: "Check dubbing status" },
  { method: "GET", path: "/v1/dubbing/:id/download", desc: "Download dubbed video" },
];

export default function DubbingApiPage() {
  return (
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
              ...
              <Badge variant="secondary" className="mb-6"><Video className="h-3 w-3 mr-1" /> Dubbing API</Badge>
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Dubbing API</h1>
              <p className="text-lg text-muted-foreground mb-8 max-w-xl">Automatically dub videos into any language via API.</p>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {["30+ languages", "Voice preservation", "Lip sync", "Batch processing"].map((f) => (
