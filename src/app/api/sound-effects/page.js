...
const endpoints = [
  { method: "POST", path: "/v1/sound-effects", desc: "Generate sound effect from text" },
  { method: "GET", path: "/v1/sound-effects/:id", desc: "Check generation status" },
  { method: "GET", path: "/v1/sound-effects/:id/download", desc: "Download sound effect" },
];

export default function SoundEffectsApiPage() {
  return (
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 py-16 md:py-24">
          <div className="container mx-auto px-4 md:px-6">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="max-w-3xl">
              ...
              <Badge variant="secondary" className="mb-6"><Volume2 className="h-3 w-3 mr-1" /> Sound Effects API</Badge>
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-6">Sound Effects API</h1>
              <p className="text-lg text-muted-foreground mb-8 max-w-xl">Create custom sound effects via API.</p>
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {["Any sound from text", "Custom duration", "Multiple formats", "Commercial rights"].map((f) => (
